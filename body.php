    ...
    <div class="container">
      <div class="row py-5">
        <div class="col">
          ...
          <p>PUEDO CONSULTAR UN ARREGLO CICLO FOR</p>
          <ul>
          ...
          <p>Info de planetas de Star Wars separados por comas:
          <strong><?php for($i = 0; $i < count($csv); $i++){
              if ($i < count($csv)-2){
                print($csv[$i][name].', ');
          ...
          <hr>
           ...
           <p>Tengo info de los sgtes. planetas de Star Wars en una lista:</p>
           <ul>
            <?php for($a = 0; $a < count($starwars); $a++){
            print('<li>'.$starwars[$a].'</li>');
            }?>
          </ul>
